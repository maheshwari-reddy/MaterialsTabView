package maheshwari.developer.materialsTabView.custom_view;
...
public class HistoryButtonView extends View {

    private static final String TAG = "HistoryButtonView";
    ...
    private static final String mTitleText = "VIEW";
    ...
    private Paint mContentItemFourPaint;
    private Paint mContentItemFivePaint;
    ...
    public HistoryButtonView(Context context) {
        this(context, null, 0);
    }

    public HistoryButtonView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HistoryButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaints() {
        ...
        mContentItemOnePaint.setTextSize(30);

        mContentItemTwoPaint = new Paint();
        mContentItemTwoPaint.setColor(Color.WHITE);
        mContentItemTwoPaint.setTextSize(30);

        mContentItemThreePaint = new Paint();
        mContentItemThreePaint.setColor(Color.WHITE);
        mContentItemThreePaint.setTextSize(30);

        mContentItemFourPaint = new Paint();
        mContentItemFourPaint.setColor(Color.WHITE);
        mContentItemFourPaint.setTextSize(30);

        mContentItemFivePaint = new Paint();
        mContentItemFivePaint.setColor(Color.WHITE);
        mContentItemFivePaint.setTextSize(30);
    ...
    private void drawContentItem(Canvas canvas) {
        ...
        drawContentItemsText(canvas, "Steve", "3", 1, mContentItemOnePaint);
        drawContentItemsText(canvas, "Mark", "1", 2, mContentItemTwoPaint);
        drawContentItemsText(canvas, "Shawn", "4", 3, mContentItemThreePaint);
        drawContentItemsText(canvas, "Ryan", "2", 4, mContentItemFourPaint);
        drawContentItemsText(canvas, "John", "5", 5, mContentItemFivePaint);
    }

    public void drawContentItemsText(Canvas canvas, String type, String number, int itemIndex, Paint paint) {
    ...
    public void startRevealAnim() {
        ...
        revealAnimSet.playTogether(mHeightAnim, mRevealAnim, contentItemOneAlphaAnim, contentItemTwoAlphaAnim, contentItemThreeAlphaAnim, mContentTextMoveAnim);
